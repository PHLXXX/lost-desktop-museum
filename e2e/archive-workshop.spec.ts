...
test('captures the complete Archive Workshop visual acceptance set', async ({ page }) => {
  ...
  await page.getByRole('button', { name: '玩法设计' }).click()
  await expect(page.getByRole('heading', { name: '玩法设计' })).toBeVisible()
  await expect(page.getByLabel('初始分析额度')).toHaveValue('3')
  await page.screenshot({ path: 'docs/images/stage6-gameplay-editor.png', fullPage: true })
