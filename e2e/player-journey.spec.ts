...
test('all 12 clues, password 1119, evidence relation and final deduction remain reachable', async ({ page }) => {
  ...
  await expect(page.locator('.result-screen')).toContainText('目标完成 4 / 5')
  await expect(page.locator('.result-screen')).toContainText('本次挑战 4 / 5')
  await expect(page.locator('.result-screen')).toContainText('使用提示 0 层')
  await expect(page.locator('.result-screen')).toContainText('档案结论')
