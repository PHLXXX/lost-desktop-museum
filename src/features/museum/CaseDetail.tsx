...
export function CaseDetail({ onBack, onStart, onContinue }: { onBack: () => void; onStart: () => void; onContinue: () => void }) {
  ...
  return (
    <main className="case-detail-shell">
      <header className="detail-header"><button onClick={onBack}>← 返回档案馆</button><span>档案 001 · LD-001</span></header>
      <div className="case-file">
        ...
        <article>
          ...
          <p className="case-lead">周屿原计划搭乘 HX217 前往北岸市，但电脑中同时留下航班取消、旧照片和异常本地登录记录。</p>
          <dl className="case-facts">
            <div><dt>电脑主人</dt><dd>{caseDefinition.owner}</dd></div>
            <div><dt>最后登录</dt><dd>2031.11.17 23:48</dd></div>
            <div><dt>案件目标</dt><dd>记录至少 6 条线索后提交推理，完整档案含 12 条线索</dd></div>
            <div><dt>建议游玩时间</dt><dd>15—30 分钟</dd></div>
            <div><dt>当前进度</dt><dd>{discoveredClueIds.length} / 12</dd></div>
