...
export type EditorSection = 'overview' | 'metadata' | 'entities' | 'timeline' | 'desktop' | 'applications' | 'files' | 'messages' | 'mail' | 'photos' | 'browser' | 'calendar' | 'logs' | 'audio' | 'broadcast' | 'clues' | 'triggers' | 'deduction' | 'assets' | 'validation'
